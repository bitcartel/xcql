...
import Database.XCQL.Protocol.Codec (getValue, putValue)
import Database.XCQL.Protocol.Tuple.TH
...
-- Tuples -------------------------------------------------------------------
-- Database.XCQL.Protocol.Tuple does not export 'PrivateTuple' but only
